...
function SideBar() {
    ...
    return (
        <div className="flex ">
            ...
            >
             ...
             border-2 rounded-full  ${!open && "rotate-180"}`}
                ...
                ${Menu.gap ? "mt-9" : "mt-2"} ${index === 0 && "bg-light-white"
                        ...
                        >
                            <img src={`https://raw.githubusercontent.com/Sridhar-C-25/sidebar_reactTailwind/refs/heads/main/src/assets/${Menu.src}.png`} />
            ...
            <div className="h-screen flex-1 p-7 border-l">
