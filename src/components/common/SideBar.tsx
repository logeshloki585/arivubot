...
function NewSideBar(props: any) {
  ...
  return (
    <div className="flex ">
      ...
      >
        ...
        <ul className="pt-6">
          {Menus.map((Menu, index) => (
            ...
            >
              <img
                src={`https://raw.githubusercontent.com/Sridhar-C-25/sidebar_reactTailwind/refs/heads/main/src/assets/${Menu.src}.png`}
              />
      ...
      <div className="h-screen flex-1 p-7 border-l">{props.children}</div>
    </div>
  );
}
