            ...
            return (
                ...
                z > W
                    ? ((C.sortIndex = z),
                        ...
                        n(s) === null &&
                        C === n(d) &&
                        (k ? (c(N), (N = -1)) : (k = !0), yl(v, z - W)))
                    : ((C.sortIndex = G), t(s, C), w || g || ((w = !0), vl(x))),
                C
            );
        }),
...
function Ic(e, t, n, r, l, o, i, u, s) {
    (Cn = !1), (jr = null), Oc.apply(Dc, arguments);
}
...
var on = {
    ...
    Pl = we(lf),
    of = A({}, on, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    uf = we(of),
    sf = A({}, on, {
...
var hf = A({}, Zn, {
    ...
    wf = we(gf),
    kf = A({}, on, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Sf = we(kf),
    xf = A({}, nl, {
        deltaX: function (e) {
...
var _f = Qe && "TextEvent" in window && !En,
    Os = Qe && (!ni || (En && 8 < En && 11 >= En)),
    qi = " ",
    bi = !1;
function Ds(e, t) {
    switch (e) {
...
function ht() {
    if (!Il && Ae !== null) {
        ...
        try {
            ...
            throw (Ae !== null && (Ae = Ae.slice(e + 1)), xs(Go, ht), l);
        } finally {
            (M = t), (Il = !1);
        }
    }
...
var Bt = [],
    ...
    He = "";
function gt(e, t) {
    (Bt[At++] = Vr), (Bt[At++] = Ar), (Ar = e), (Vr = t);
}
function qs(e, t, n) {
    (Se[xe++] = Ve), (Se[xe++] = He), (Se[xe++] = Nt), (Nt = e);
    var r = Ve;
    e = He;
    var l = 32 - Re(r) - 1;
    (r &= ~(1 << l)), (n += 1);
...
function oi(e) {
    for (; e === Ar;)
        (Ar = Bt[--At]), (Bt[At] = null), (Vr = Bt[--At]), (Bt[At] = null);
    for (; e === Nt;)
        (Nt = Se[--xe]),
            (Se[xe] = null),
            (He = Se[--xe]),
...
function ta(e) {
    ...
    function s(c, a, f, v) {
        ...
        return x === Ot
            ...
            : a !== null &&
                ...
                : ((v = zr(f.type, f.key, f.props, null, c.mode, v)),
                    (v.ref = hn(c, a, f)),
                    (v.return = c),
                    v);
    }
    ...
    function h(c, a, f, v, x) {
        return a === null || a.tag !== 7
            ? ((a = Et(f, c.mode, v, x)), (a.return = c), a)
            : ((a = l(a, f)), (a.return = c), a);
    }
    function m(c, a, f) {
        ...
        if (typeof a == "object" && a !== null) {
            ...
            if (wn(a) || cn(a))
                return (a = Et(a, c.mode, f, null)), (a.return = c), a;
            pr(c, a);
        }
        return null;
    }
    ...
    function w(c, a, f, v) {
        for (
            var x = null, E = null, _ = a, N = (a = 0), H = null;
            _ !== null && N < f.length;
            N++
        ) {
        ...
        if (_ === null) {
            for (; N < f.length; N++)
                (_ = m(c, f[N], v)),
                    _ !== null &&
                    ((a = o(_, a, N)), E === null ? (x = _) : (E.sibling = _), (E = _));
            return $ && gt(c, N), x;
        }
    ...
    function k(c, a, f, v) {
        ...
        for (
            var E = (x = null), _ = a, N = (a = 0), H = null, j = f.next();
            _ !== null && !j.done;
            N++, j = f.next()
        ) {
            _.index > N ? ((H = _), (_ = null)) : (H = _.sibling);
        ...
        if (_ === null) {
            for (; !j.done; N++, j = f.next())
                (j = m(c, j.value, v)),
                    j !== null &&
                    ((a = o(j, a, N)), E === null ? (x = j) : (E.sibling = j), (E = j));
            return $ && gt(c, N), x;
        }
            ...
            switch (f.$$typeof) {
                case nr:
                    e: {
                        ...
                        f.type === Ot
                            ? ((a = Et(f.props.children, c.mode, v, f.key)),
                                (a.return = c),
                                (c = a))
                            : ((v = zr(f.type, f.key, f.props, null, c.mode, v)),
                                (v.ref = hn(c, a, f)),
                ...
                case Mt:
                    ...
                    return i(c);
                case Je:
                    return (E = f._init), O(c, a, E(f._payload), v);
            }
...
function di(e, t) {
    switch ((D(Hn, t), D(Vn, e), D(Ue, qn), (e = t.nodeType), e)) {
        case 9:
        case 11:
...
function vi(e, t, n, r, l, o) {
    if (
        ((Pt = o),
            ...
            (t.updateQueue = null),
            (t.lanes = 0),
            (Er.current = e === null || e.memoizedState === null ? ed : td),
            (e = n(r, l)),
            Pn)
    ) {
        o = 0;
...
function ka(e, t, n) {
    return Pt & 21
        ? (Oe(n, t) || ((n = _s()), (B.lanes |= n), (Lt |= n), (e.baseState = !0)),
            t)
...
function bf(e, t, n) {
    ...
    if (xa(e)) Ca(t, l);
        ...
        (n = ra(e, t, l, r)),
            n !== null && ((l = ie()), Me(n, e, r, l), Ea(n, t, r));
    }
}
function xa(e) {
    var t = e.alternate;
...
function Lu(e, t, n, r, l) {
    ...
    if ((Gt(t, l), t.stateNode === null))
        Nr(e, t), _a(t, n, r), Co(t, n, r, l), (r = !0);
    else if (e === null) {
        var i = t.stateNode,
            u = t.memoizedProps;
        i.props = u;
...
function od(e, t, n, r, l, o, i) {
    if (n)
        return t.flags & 256
            ? ((t.flags &= -257), (r = Al(Error(y(422)))), mr(e, t, i, r))
            : t.memoizedState !== null
    ...
    if (l.data === "$!") {
        ...
        return (r = u), (o = Error(y(419))), (r = Al(o, r, void 0)), mr(e, t, i, r);
    }
    if (((u = (i & e.childLanes) !== 0), ce || u)) {
        ...
        return Ni(), (r = Al(Error(y(421)))), mr(e, t, i, r);
    }
    return l.data === "$?"
        ? ((t.flags |= 128),
            (t.child = e.child),
...
function ud(e, t, n) {
    ...
    switch ((oi(t), t.tag)) {
        ...
        case 4:
            return (
                tn(), zo(e, t), e === null && Un(t.stateNode.containerInfo), ne(t), null
            );
        case 10:
...
function Fa(e) {
    ...
    t !== null && ((e.alternate = null), Fa(t)),
        ...
        ((t = e.stateNode),
            t !== null &&
            (delete t[Fe], delete t[An], delete t[yo], delete t[Kf], delete t[Yf])),
        (e.stateNode = null),
        (e.return = null),
        (e.dependencies = null),
...
function Ba(e, t) {
    ...
    switch (e.tag) {
        ...
        case 15:
            ...
            break;
        case 1:
            Le(t, e), De(e), r & 512 && n !== null && Ht(n, n.return);
            break;
        case 5:
            if (
                (Le(t, e),
        ...
        case 22:
            if (
                ((h = n !== null && n.memoizedState !== null),
                    e.mode & 1 ? ((re = (d = re) || h), Le(t, e), (re = d)) : Le(t, e),
                    De(e),
                    r & 8192)
            ) {
                if (
...
function Va(e, t) {
    ...
    if (r & 30 || r & e.expiredLanes || t) t = qr(e, r);
        ...
        R |= 2;
        var o = Wa();
        (J !== e || b !== t) && ((Be = null), (rn = Q() + 500), Ct(e, t));
        do
            try {
                hd();
                break;
...
Xa = function (e, t, n) {
    ...
    else (ce = !1), $ && t.flags & 1048576 && qs(t, Vr, t.index);
...
function zr(e, t, n, r, l, o) {
    ...
    if (((r = e), typeof e == "function")) Pi(e) && (i = 1);
        ...
        e: switch (e) {
            ...
            case Kl:
                return (
                    (e = Ce(12, n, t, l | 2)), (e.elementType = Kl), (e.lanes = o), e
                );
            case Yl:
                return (e = Ce(13, n, t, l)), (e.elementType = Yl), (e.lanes = o), e;
            case Xl:
...
vs = Ei;
ys = zt;
var Nd = { usingClientEntryPoint: !1, Events: [Jn, $t, ol, ms, hs, Ei] },
    yn = {
    ...
    Pd = {
        ...
        findFiberByHostInstance: yn.findFiberByHostInstance || Ed,
...
function zd() {
    const [e, t] = ke.useState(!1),
        [n, r] = ke.useState([
            ...
            {
                bot: "Sure! Can you tell me what issue you are facing?",
                user: "hi!!!....",
            },
        ]),
        [l, o] = ke.useState({
            ...
            P.jsxs(P.Fragment, {
                children: [
                    ...
                    P.jsx("div", {
                        className: "relative",
                        children: P.jsxs("div", {
                            className: `fixed bottom-24 right-4 w-[350px] lg:w-[500px] xl:w-[33vw] h-[80vh]  lg:h-[80vh] xl:h-[85vh] bg-white bg-[${l.bgColor
                                }] p-4 rounded-lg border border-[#e5e7eb] shadow-2xl transform transition-all duration-500 ease-in-out ${e
                                ...
                                P.jsx("div", {
                                    ...
                                    children: n.map((c, a) =>
                                        P.jsxs(
                                            "div",
                                            {
                                                className: `flex flex-col gap-3 my-4 text-sm ${c.user ? "justify-end" : "justify-start"
                                                    }`,
                                                children: [
                                                    c.user &&
                                                    P.jsx("div", {
                                    ...
                                    children: P.jsxs("form", {
                                        ...
                                        children: [
                                            P.jsx("input", {
                                                ...
                                                disabled: d,
                                                className:
                                                    "flex h-10 w-full rounded-md px-3 text-sm placeholder-[#6b7280] focus:outline-none text-[#030712]",
                    ...
                    !e &&
                    P.jsx("div", {
                        className: `fixed bottom-24 transform transition-all ease-out duration-500 ${m ? "translate-x-0 right-4" : "translate-x-full"
...
ec(document.getElementById("arivubot")).render(
    P.jsx(ke.StrictMode, { children: P.jsx(zd, {}) })
);
